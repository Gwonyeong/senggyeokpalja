            ...
            >
              <div className="login-btn-icon">
                <svg width="20" height="20" viewBox="0 0 24 24">
                  <path
                    fill="#000000"
                    d="M12 3C7.03 3 3 6.14 3 10.1c0 2.52 1.65 4.73 4.1 6.09l-.95 3.48c-.09.33.25.59.55.42l4.28-2.69c.34.03.68.04 1.02.04 4.97 0 9-3.14 9-7.1S16.97 3 12 3z"
                  />
                </svg>
              </div>
              <span className="login-btn-text">

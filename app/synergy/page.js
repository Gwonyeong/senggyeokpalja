...
export default function SynergyPage() {
  ...
  const paljaTypes = [
    {
      ...
      name: "이른 봄의 햇살",
      description:
        "타인을 배려하며 조화로운 관계를 추구하는 따뜻한 마음의 소유자",
    },
    {
      code: "NGHY",
      name: "이야기를 만드는 작가",
      description:
        "감성이 풍부하고 창의적이며 자유로운 영혼을 가진 예술가 기질",
    },
    {
      code: "NGIJ",
      name: "고요한 밤의 등대",
      description: "깊은 통찰력으로 타인을 이해하고 조언하는 지혜로운 상담자",
    },
    {
      code: "NGIY",
      name: "자신만의 섬을 가진 탐험가",
      description:
        "이상을 추구하며 세상을 더 나은 곳으로 만들고자 하는 꿈꾸는 이상주의자",
    },
    {
      code: "NSHJ",
      name: "진심을 담는 공예가",
      description: "체계적이고 신중하게 일을 처리하는 믿음직한 관리자",
    },
    {
      code: "NSHY",
      name: "일상 속 여행자",
      description: "조용하지만 따뜻하게 주변을 돌보는 온화한 수호자",
    },
    {
      code: "NSIJ",
      name: "믿음을 주는 기준점",
      description: "세심하고 완벽을 추구하는 뛰어난 기술과 감각의 장인",
    },
    {
      code: "NSIY",
      name: "자신만의 검을 벼리는 장인",
      description: "새로운 경험을 추구하며 순간을 즐기는 모험심 넘치는 탐험가",
    },
    {
      code: "WGHJ",
      name: "마음을 잇는 메신저",
      description: "타인을 이끌고 동기부여하는 천부적인 카리스마를 가진 리더",
    },
    {
      code: "WGHY",
      name: "가을 들판의 풍요",
      description: "사교적이고 활발하며 주변을 즐겁게 만드는 연예인 기질",
    },
    {
      code: "WGIJ",
      name: "꿈을 짓는 설계자",
      description: "신념을 가지고 세상을 변화시키려는 열정적인 활동가",
    },
    {
      code: "WGIY",
      name: "세상을 바꾸는 물결",
      description:
        "창의적 아이디어로 새로운 가능성을 제시하는 영감을 주는 혁신가",
    },
    {
      code: "WSHJ",
      name: "숲을 가꾸는 정원사",
      description: "현실적이고 효율적으로 목표를 달성하는 실용적인 경영자",
    },
    {
      code: "WSHY",
      name: "영감을 주는 아티스트",
      description: "팀워크를 중시하며 모두와 잘 어울리는 친근한 협력자",
    },
    {
      code: "WSIJ",
      name: "별을 읽는 책사",
      description: "체계적 사고로 문제를 해결하는 논리적이고 객관적인 분석가",
    },
    {
      code: "WSIY",
      name: "길을 여는 불꽃",
      description:
        "위험을 감수하며 새로운 기회를 창출하는 도전정신 넘치는 기업가",
    },
  ];
  ...
  const calculateCompatibility = (mbti, paljaCode) => {
    ...
    const scores = {
      energy:
        synergyScoring.energy[`${mbtiTraits.energy}-${paljaTraits.energy}`] ||
        0,
      lifestyle:
        synergyScoring.lifestyle[
          `${mbtiTraits.lifestyle}-${paljaTraits.lifestyle}`
        ] || 0,
      perception:
        synergyScoring.perception[
          `${mbtiTraits.perception}-${paljaTraits.perception}`
        ] || 0,
      decision:
        synergyScoring.decision[
          `${mbtiTraits.decision}-${paljaTraits.decision}`
        ] || 0,
    };

    // 4. 총점 계산
    const totalScore =
      scores.energy + scores.lifestyle + scores.perception + scores.decision;
                  ...
                  {result && (
                    <div className="card result-card">
                      <div className="result-header">
                        <h3>
                          🎭 {result.mbti} ×{" "}
                          {paljaTypes.find((p) => p.code === result.palja)
                            ?.name || result.palja}
                        </h3>
                      ...
                      <div className="result-content">
                        <div className="synergy-score-display">
                          <div className="circular-progress">
                            <svg viewBox="0 0 120 120">
                              ...
                              ></circle>
                              <circle
                                className={`progress-circle ${getSynergyClass(
                                ...
                                data-target={
                                  (result.compatibilityScore / 100) * 327
                                }
                              ></circle>
                            </svg>
                        ...
                        <div className="info-card breakdown-card">
                          ...
                          <div className="synergy-graph">
                            <div className="graph-item">
                              <div className="graph-label">
                                ...
                                <span className="graph-score">
                                  {result.breakdown.energy}점
                                </span>
                              </div>
                              <div className="progress-bar">
                                <div
                                  ...
                                  data-width={
                                    (result.breakdown.energy / 25) * 100
                                  }
                                ></div>
                              </div>
                            </div>
                            <div className="graph-item">
                              <div className="graph-label">
                                <span className="graph-dimension">
                                  라이프스타일
                                </span>
                                <span className="graph-score">
                                  {result.breakdown.lifestyle}점
                                </span>
                              </div>
                              <div className="progress-bar">
                                <div
                                  ...
                                  data-width={
                                    (result.breakdown.lifestyle / 25) * 100
                                  }
                                ></div>
                              </div>
                            </div>
                            <div className="graph-item">
                              ...
                              <div className="progress-bar">
                                <div
                                  ...
                                  data-width={
                                    (result.breakdown.perception / 25) * 100
                                  }
                                ></div>
                              </div>
                            </div>
                            <div className="graph-item">
                              ...
                              <div className="progress-bar">
                                <div
                                  ...
                                  data-width={
                                    (result.breakdown.decision / 25) * 100
                                  }
                                ></div>
                              </div>
                            </div>
                          ...
                          <div className="dimension-explanations">
                            <div>
                              <strong>에너지:</strong> 내향성(I)과 외향성(E)의
                              조화 - 혼자만의 시간과 사람들과의 시간 균형
                            </div>
                            <div>
                              <strong>라이프스타일:</strong> 계획성(J)과
                              유연성(P)의 조화 - 체계적 접근과 즉흥적 대응의
                              균형
                            </div>
                            <div>
                              <strong>인식방식:</strong> 감각(S)과 직관(N)의
                              조화 - 현실적 정보와 미래 가능성의 균형
                            </div>
                            <div>
                              <strong>판단방식:</strong> 사고(T)와 감정(F)의
                              조화 - 논리적 분석과 감정적 고려의 균형
                            </div>
                          </div>
                        </div>

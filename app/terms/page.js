        ...
        <div style={{
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '20px' }}>
              본 약관은 성격팔자가 운영하는 성격팔자 사이트 (이하 &ldquo;당 사이트&rdquo;)에서 제공하는 모든 서비스(이하 &ldquo;서비스&rdquo;)의 이용조건 및 절차, 이용자와 각 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '15px' }}>본 약관에서 사용하는 용어의 정의는 다음과 같습니다.</p>
            <ul style={{ marginBottom: '20px', paddingLeft: '20px' }}>
              <li style={{ marginBottom: '10px' }}><strong>이용자</strong> : 본 약관에 따라 당 사이트가 제공하는 서비스를 받는 자</li>
              <li style={{ marginBottom: '10px' }}><strong>회원</strong> : 당 사이트에 개인 정보를 제공하여 회원 등록을 한 자로서, 당 사이트의 정보 및 서비스를 이용할 수 있는 자</li>
              <li style={{ marginBottom: '10px' }}><strong>아이디</strong> : 당 사이트 회원가입 시 발급받은 회원의 신분을 증명하는 고유 코드</li>
              <li style={{ marginBottom: '10px' }}><strong>비밀번호</strong> : 아이디에 대한 본인 여부를 확인하기 위하여 사용하는 문자, 숫자, 특수 문자등의 조합</li>
              <li style={{ marginBottom: '10px' }}><strong>가입</strong> : 회원가입 시 제공하는 신청서 양식에 해당 정보를 기입하고, 본 약관에 동의하여 서비스 이용계약을 완료시키는 행위</li>
              <li style={{ marginBottom: '10px' }}><strong>탈퇴</strong> : 회원이 이용계약을 종료시키는 행위</li>
              <li style={{ marginBottom: '10px' }}>본 약관에서 정의하지 않은 용어는 개별서비스에 대한 별도 약관 및 이용규정에서 정의합니다.</li>
            </ul>
          </section>
          ...
          <h2 style={{
            ...
            marginBottom: '30px',
            textAlign: 'center',
            borderTop: '3px solid var(--starlight-orange)',
            paddingTop: '30px'
          }}>제 2 장 서비스 제공 및 이용</h2>
            ...
            <ul style={{ marginBottom: '20px', paddingLeft: '20px' }}>
              ...
              <li style={{ marginBottom: '15px' }}>
                ...
                <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
                  <li style={{ marginBottom: '8px' }}>다른 사람의 명의를 사용하여 신청한 경우</li>
                  <li style={{ marginBottom: '8px' }}>이용계약 신청서의 내용을 허위로 기재하였거나 신청한 경우</li>
                  <li style={{ marginBottom: '8px' }}>사회의 안녕 질서 혹은 미풍양속을 저해할 목적으로 신청한 경우</li>
                  <li style={{ marginBottom: '8px' }}>다른 사람의 당 사이트 서비스 이용을 방해하거나 그 정보를 도용하는 등의 행위를 한 경우</li>
                  <li style={{ marginBottom: '8px' }}>당 사이트를 이용하여 법령과 본 약관이 금지하는 행위를 한 경우</li>
                  <li style={{ marginBottom: '8px' }}>기타 당 사이트가 정한 이용신청요건이 미비한 경우</li>
                </ul>
              </li>
              <li style={{ marginBottom: '15px' }}>
                당 사이트는 다음 각 호에 해당하는 경우 그 사유가 소멸될 때까지 이용계약 성립을 유보할 수 있습니다.
                <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
                  <li style={{ marginBottom: '8px' }}>서비스 관련 제반 용량이 부족한 경우</li>
                  <li style={{ marginBottom: '8px' }}>기술상 장애 사유가 있는 경우</li>
                </ul>
              </li>
              <li style={{ marginBottom: '15px' }}>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <ul style={{ marginBottom: '20px', paddingLeft: '20px' }}>
              ...
              <li style={{ marginBottom: '15px' }}>
                ...
                <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
                  <li style={{ marginBottom: '8px' }}><strong>개인정보의 수집</strong> : 당 사이트는 회원가입 시 회원이 제공하는 정보를 수집합니다.</li>
                  <li style={{ marginBottom: '8px' }}><strong>개인정보의 사용</strong> : 당 사이트는 서비스 제공과 관련해서 수집된 회원정보를 본인의 승낙 없이 제3자에게 누설, 배포하지 않습니다. 단, 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우, 범죄에 대한 수사상의 목적이 있거나 방송통신심의위원회의 요청이 있는 경우 또는 기타 법령에서 정한 절차에 따른 요청이 있는 경우, 회원이 당 사이트에 제공한 개인정보를 스스로 공개한 경우에는 그러하지 않습니다.</li>
                  <li style={{ marginBottom: '8px' }}><strong>개인정보의 관리</strong> : 회원은 개인정보의 보호 및 관리를 위하여 서비스의 개인정보관리에서 수시로 회원의 개인정보를 수정/삭제할 수 있습니다. 수신되는 정보 중 불필요하다고 생각되는 부분도 변경/조정할 수 있습니다.</li>
                  <li style={{ marginBottom: '8px' }}><strong>개인정보의 보호</strong> : 회원의 개인정보는 오직 회원만이 열람/수정/삭제할 수 있으며, 이는 전적으로 회원의 아이디와 비밀번호에 의해 관리되고 있습니다. 따라서 타인에게 본인의 아이디와 비밀번호를 알려주어서는 아니 되며, 작업 종료 시에는 반드시 로그아웃 해주시고, 웹 브라우저의 창을 닫아주시기 바랍니다(이는 타인과 컴퓨터를 공유하는 인터넷 카페나 도서관 같은 공공장소에서 컴퓨터를 사용하는 경우에 회원의 정보의 보호를 위하여 필요한 사항입니다.).</li>
                </ul>
              </li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <ul style={{ marginBottom: '20px', paddingLeft: '20px' }}>
              ...
              <li style={{ marginBottom: '15px' }}>
                ...
                <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
                  <li style={{ marginBottom: '8px' }}>본 이용약관에 위배되거나 상용 또는 불법, 음란, 저속하다고 판단되는 게시물을 게시한 경우</li>
                  <li style={{ marginBottom: '8px' }}>다른 이용자 또는 제3자를 비방하거나 중상모략으로 명예를 손상시키는 내용인 경우</li>
                  <li style={{ marginBottom: '8px' }}>공공질서 및 미풍양속에 위반되는 내용인 경우</li>
                  <li style={{ marginBottom: '8px' }}>범죄적 행위에 결부된다고 인정되는 내용일 경우</li>
                  <li style={{ marginBottom: '8px' }}>제3자의 저작권 등 기타 권리를 침해하는 내용인 경우</li>
                  <li style={{ marginBottom: '8px' }}>기타 관계 법령에 위배되는 경우</li>
                </ul>
              </li>
              <li style={{ marginBottom: '15px' }}>
          ...
          <section style={{ marginBottom: '40px' }}>
            <h3 style={{
              ...
              borderBottom: '2px solid var(--border-color)',
              paddingBottom: '10px'
            }}>제 13 조 (이용자의 행동규범 및 서비스 이용제한)</h3>
            <ul style={{ marginBottom: '20px', paddingLeft: '20px' }}>
              <li style={{ marginBottom: '15px' }}>
              ...
              <li style={{ marginBottom: '15px' }}>
                ...
                <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
                  <li style={{ marginBottom: '8px' }}>타인의 아이디(ID)와 비밀번호를 도용하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>저속, 음란, 모욕적, 위협적이거나 타인의 프라이버시를 침해할 수 있는 내용을 전송, 게시, 게재, 전자메일 또는 기타의 방법으로 전송하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>서비스를 통하여 전송된 내용의 출처를 위장하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>법률, 계약에 의하여 이용할 수 없는 내용을 게시, 게재, 전자메일 또는 기타의 방법으로 전송하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>타인의 특허, 상표, 영업비밀, 저작권, 기타 지적재산권을 침해하는 내용을 게시, 게재, 전자메일 또는 기타의 방법으로 전송하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>당 사이트의 승인을 받지 아니한 광고, 판촉물, 정크메일, 스팸, 행운의 편지, 피라미드 조직 기타 다른 형태의 권유를 게시, 게재, 전자메일 또는 기타의 방법으로 전송하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>다른 이용자의 개인정보를 수집 또는 저장하는 행위</li>
                </ul>
              </li>
              <li style={{ marginBottom: '15px' }}>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <ul style={{ marginBottom: '20px', paddingLeft: '20px' }}>
              ...
              <li style={{ marginBottom: '15px' }}>
                ...
                <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
                  <li style={{ marginBottom: '8px' }}>다른 회원의 ID를 부정 사용하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>범죄행위를 목적으로 하거나 기타 범죄행위와 관련된 행위</li>
                  <li style={{ marginBottom: '8px' }}>선량한 풍속, 기타 사회질서를 해하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>타인의 명예를 훼손하거나 모욕하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>타인의 지적재산권 등의 권리를 침해하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>해킹행위 또는 컴퓨터바이러스의 유포행위</li>
                  <li style={{ marginBottom: '8px' }}>타인의 의사에 반하여 광고성 정보 등 일정한 내용을 지속적으로 전송하는 행위</li>
                  <li style={{ marginBottom: '8px' }}>서비스의 안전적인 운영에 지장을 주거나 줄 우려가 있는 일체의 행위</li>
                  <li style={{ marginBottom: '8px' }}>당 사이트에 게시된 정보의 변경</li>
                  <li style={{ marginBottom: '8px' }}>기타 전기통신법 제53조와 전기통신사업법 시행령 16조(불온통신), 통신사업법 제53조 3항에 위배되는 행위</li>
                </ul>
              </li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: '40px' }}>
            <h3 style={{
              ...
              borderBottom: '2px solid var(--border-color)',
              paddingBottom: '10px'
            }}>제 20 조 (결제 취소 및 환불)</h3>

            <p style={{ marginBottom: '20px' }}>
              이용자는 서비스 내 [회원 탈퇴] 절차 혹은 고객센터를 통한 회원 탈퇴 요청을 통해 언제든지 이용계약을 해지할 수 있으며, 회사는 지체 없이 탈퇴 처리를 완료합니다.
            </p>

            <p style={{ marginBottom: '20px' }}>
              회사는 이용자가 구매 신청한 콘텐츠 서비스를 기술적인 문제 등의 사유로 제공할 수 없을 때에는 그 사유를 이용자에게 통지하고, 이미 결제가 이루어진 경우 신속하게 이를 취소하거나 환불합니다.
            </p>

            <p style={{ marginBottom: '15px' }}>
              이용자가 구매한 유료 서비스는 「전자상거래법」 등 관계법령에 따라 청약철회가 가능합니다. 다만, 다음 각 호에 해당하는 경우에는 청약철회가 제한됩니다.
            </p>

            <ol style={{ marginBottom: '20px', paddingLeft: '20px' }}>
              <li style={{ marginBottom: '10px' }}>구매 즉시 사용이 시작되거나 서비스에 즉시 적용되는 디지털 콘텐츠 (예: 프리미엄 운세 등)</li>
              <li style={{ marginBottom: '10px' }}>이용자가 이미 운세 조회 등 서비스를 이용하여 결과를 확인한 경우</li>
              <li style={{ marginBottom: '10px' }}>그 밖에 「전자상거래법 제17조 제2항」에서 정한 청약철회 제한 사유에 해당하는 경우</li>
            </ol>

            <p style={{ marginBottom: '20px' }}>
              위 각 호에 해당하지 않는 경우, 이용자는 결제일로부터 <strong>7일 이내</strong>에 청약철회를 요청할 수 있으며 회사는 관련 법령이 정한 바에 따라 환불 절차를 진행합니다.
            </p>

            <p style={{ marginBottom: '20px' }}>
              회사는 환불 요청이 정당한 경우, <strong>지체 없이</strong> 결제를 취소하거나 환불을 진행하며, 환불에 소요되는 비용은 회사가 부담합니다.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '20px' }}>
              본 서비스 이용과 관련하여 발생한 분쟁에 대해 소송이 제기될 경우 의정부 지방법원을 전속적 관할 법원으로 합니다.
            </p>
          </section>
          ...
          <section style={{
            ...
            <p style={{ marginBottom: '15px', textAlign: 'center' }}>
              <strong>[시행일]</strong> 본 약관은 2025년 09월 16일부터 시행됩니다.
            </p>

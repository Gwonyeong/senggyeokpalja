...
import { calculateSaju, calculateSinsalFromConsultation, enrichSinsalData } from "../../lib/saju-utils";
...
export default function SajuChart({ consultation }) {
  ...
  // 십성 데이터 추출 (천간 기준)
  const extractTenGodsForStem = (stem, position) => {
    ...
    // 완전한 십성 매핑 테이블
    const tenGodMapping = {
      "甲": { "乙": "겁재", "丙": "식신", "丁": "상관", "戊": "편재", "己": "정재", "庚": "편관", "辛": "정관", "壬": "편인", "癸": "정인" },
      "乙": { "甲": "겁재", "丙": "상관", "丁": "식신", "戊": "정재", "己": "편재", "庚": "정관", "辛": "편관", "壬": "정인", "癸": "편인" },
      "丙": { "甲": "편인", "乙": "정인", "丁": "겁재", "戊": "식신", "己": "상관", "庚": "편재", "辛": "정재", "壬": "편관", "癸": "정관" },
      "丁": { "甲": "정인", "乙": "편인", "丙": "겁재", "戊": "상관", "己": "식신", "庚": "정재", "辛": "편재", "壬": "정관", "癸": "편관" },
      "戊": { "甲": "편관", "乙": "정관", "丙": "편인", "丁": "정인", "己": "겁재", "庚": "식신", "辛": "상관", "壬": "편재", "癸": "정재" },
      "己": { "甲": "정관", "乙": "편관", "丙": "정인", "丁": "편인", "戊": "겁재", "庚": "상관", "辛": "식신", "壬": "정재", "癸": "편재" },
      "庚": { "甲": "편재", "乙": "정재", "丙": "편관", "丁": "정관", "戊": "편인", "己": "정인", "辛": "겁재", "壬": "식신", "癸": "상관" },
      "辛": { "甲": "정재", "乙": "편재", "丙": "정관", "丁": "편관", "戊": "정인", "己": "편인", "庚": "겁재", "壬": "상관", "癸": "식신" },
      "壬": { "甲": "식신", "乙": "상관", "丙": "편재", "丁": "정재", "戊": "편관", "己": "정관", "庚": "편인", "辛": "정인", "癸": "겁재" },
      "癸": { "甲": "상관", "乙": "식신", "丙": "정재", "丁": "편재", "戊": "정관", "己": "편관", "庚": "정인", "辛": "편인", "壬": "겁재" }
    };
  ...
  const extractTenGodsForBranch = (branch) => {
    ...
    // 지지의 본기로 십성 계산
    return extractTenGodsForStem(branchMainStem, "branch");
  };
  ...
  const chartData = [
    {
      position: "생시",
      sipseong_top: extractTenGodsForStem(timeStem, "time"),
    ...
    {
      position: "생일",
      sipseong_top: extractTenGodsForStem(dayStem, "day"),
    ...
    {
      position: "생월",
      sipseong_top: extractTenGodsForStem(monthStem, "month"),
    ...
    {
      position: "생년",
      sipseong_top: extractTenGodsForStem(yearStem, "year"),
  ...
  // 사용자 이름 추출 (임시로 '고객'으로 설정, 실제로는 consultation에서 가져와야 함)
  const userName = consultation?.user?.displayName || "고객";
